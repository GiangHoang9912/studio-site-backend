...
Route::group(['prefix' => 'api', 'as' => 'api.'], function () {
    Route::get('/get-all-post', ['as' => 'index', 'uses' => 'Blog\BlogController@index_api']);
    Route::get('/post/{title}/{id}', ['as' => 'post', 'uses' => 'Blog\PostController@index_api'])->where('id', '[0-9]+');
    Route::post('/comment/{title}/{id}', ['as' => 'comment', 'uses' => 'Blog\CommentController@index_api'])->where('id', '[0-9]+');
